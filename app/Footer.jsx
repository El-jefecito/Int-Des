  ...
  return (
    <>
      <footer className="relative z-10">
        ...
        <div className="absolute bottom-0 right-0 w-full h-full bg-[url('/footer-shape.svg)] bg-no-repeat bg-bottom-right invert z-[-1]" />
          ...
          <div className="flex flex-col lg:flex-row lg:justify-between gap-12 ">
            ...
            <div className="lg:w-1/2 pr-10 lg:pr-0 ">
              ...
              <p className="my-5 text-lg font-medium">
                ...
                furniture and design disciplines and expertise.
              </p>
              ...
              <div>
                ...
                <div className="lg:flex-1 mt-5">
                  ...
                  <p className="text-lg font-medium max-w-sm">
                    ...
                    Doloremque, et necessitatibus beatae. Quidem odio similique
                    cum facilis temporibus fuga, soluta consectetur!
                  </p>
                </div>
              </div>
        ...
        <div className="border-b border-gray-300 py-6 bg-white">
          <p className="text-center text-lg">
            ©️ 2025 copyright All Rights Reserved By
